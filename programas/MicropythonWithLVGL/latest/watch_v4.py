...
class WATCH:
  ...
  def drawLogButtons (self):
    ...
    self.btnBk.align(lv.ALIGN.CENTER,round(-105*1),round(-105*0))
    ...
    self.btnSt.align(lv.ALIGN.CENTER,round(105*0),round(105*1))
    lbl.set_style_text_font(lv.font_montserrat_16,0)
    ...
    self.btnGo.align(lv.ALIGN.CENTER,round(105*1),round(-105*0))
    lbl.set_style_text_font(lv.font_montserrat_16,0)
    ...
    self.btnWk.align(lv.ALIGN.CENTER,round(-105*0),round(-105*1))
    lbl.set_style_text_font(lv.font_montserrat_16,0)
    lbl.set_text(lv.SYMBOL.EJECT)
    self.btnGo.add_event_cb(lambda e: self.log('Caminhar'), lv.EVENT.CLICKED, None) # deploy.w.cancelSleep()

    self.btnWa=lv.button(lv.screen_active())
    lbl=lv.label(self.btnWa)
    self.btnWa.align(lv.ALIGN.CENTER,round(-105*0),round(-105*0))
    lbl.set_style_text_font(lv.font_montserrat_16,0)
